...
function Navbar() {
    ...
    return (
        <div>
            <nav className="bg-slate-50 dark:bg-slate-800 md:mb-4 mt-5 md:mt-0 p-5 rounded-3xl flex justify-around text-slate-950 dark:text-gray-50 md:relative fixed bottom-0 left-0 right-0 z-10 mx-5 md:mx-0">
